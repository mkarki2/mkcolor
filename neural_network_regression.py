...
def do_mlp(dataset, learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, batch_size=10, n_hidden=500):
    """
        ...
        for minibatch_index in range(int(n_train_batches)):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    best_iter = iter
                    # save the best model
                    with open('best_model_linear.pkl', 'wb') as f:
...
def predict():
    ...
    classifier =pickle.load(open('best_model_linear.pkl'))
